...
describe('History', () => {
    it('empty', () => {
        ...
        expect(_0.isRedoable()).toBe(false);
    ...
    it('push single + undo - redo', () => {
        ...
        expect(_1.isRedoable()).toBe(true);
    ...
    it('push several + undo - redo', () => {
        ...
        expect(_2.isRedoable()).toBe(true);
        ...
        expect(_3.isRedoable()).toBe(true);
        ...
        expect(_4.isRedoable()).toBe(false); // clears redos
